...
<section class="section">
    <div class="row">
        <div class="col-lg-12">
            ...
            <div class="card">
                <div class="card-body">
                    <h5 class="card-title text-center">Formulaire de validation de la demande</h5>

                    <!-- Formulaire approuver demande soutenance -->

                    <form method="POST" action="{{url('approuver_dmd', [$demandes->id])}}" class="row g-3">
                        @csrf

                        <div class="col-12" >
                            <label for="recipient-name" class="col-form-label">Motif de statut de la demande de soutenance</label>
